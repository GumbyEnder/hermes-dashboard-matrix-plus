...
# ── Static file path ─────────────────────────────────────────────────────────
_SRC2_INDEX_HTML_PATH = REPO_ROOT / 'redesign_src2' / 'dist' / 'index.html'
_INDEX_HTML_PATH = _SRC2_INDEX_HTML_PATH if _SRC2_INDEX_HTML_PATH.exists() else REPO_ROOT / 'static' / 'index.html'
