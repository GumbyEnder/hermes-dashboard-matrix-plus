...
- Set `HERMES_WEBUI_PASSWORD=*** env var. Restart. All pages redirect to `/login`.
...
## 2026-04-12 redesign merge validation
- python -m py_compile server.py
- node --check static/boot.js static/commands.js static/panels.js static/sessions.js static/ui.js
- curl http://127.0.0.1:8787/health
- Manual UI verify on live URL: Projects opens/binds thread, Reports shows model usage/cost + live agents, right workspace panel shows compact resources, theme switching persists via hermes-theme key.

- pytest tests/test_project_thread_smoke.py -q  # project metadata editor + project/thread binding smoke coverage

## 2026-04-12 Validation run (2026-04-12T19:51:21Z)
- `python -m py_compile server.py` ✅
- `node --check static/boot.js static/panels.js static/commands.js static/command_palette.js` ✅
- `curl http://127.0.0.1:8787/health` ✅ status ok
- Browser smoke at `http://100.122.198.32:8787/` ✅ redesigned rail/nav visible, no JS console errors
